...
//Global Variables
char usart_rx_buffer[501];											//Define a buffer for storing serial port strings
...
//		printf("@S=%u.%u\r",linkaddr_node_addr.u8[0], 	linkaddr_node_addr.u8[1]);
	...
	else if (strncmp(usart_rx_buffer,"!",1) == 0)
	{
    ...
    uip_udp_packet_send(server_conn, usart_rx_buffer, strlen(usart_rx_buffer));
...
//	}
	...
	strlcpy(usart_rx_buffer,"",sizeof(""));
